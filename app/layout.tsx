  ...
  return (
    <html lang="en">
      ...
      >
        <AuthProvider>
          <AuthModalProvider>
            <div className="relative min-h-screen overflow-x-clip bg-[hsl(var(--quran-bg))]">
              <div
                aria-hidden
                className="pointer-events-none absolute inset-0 -z-10 overflow-hidden"
              >
                <div className="absolute inset-x-0 top-0 h-[26rem] bg-[radial-gradient(circle_at_top,hsl(var(--quran-light-green)/0.22),transparent_70%)]" />
